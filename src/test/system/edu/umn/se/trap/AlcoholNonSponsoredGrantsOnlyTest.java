 ...
 *
 */
public class AlcoholNonSponsoredGrantsOnlyTest extends AbstractSystemTest
{
    ...
    @Test
    public void testAlcoholSponsored() throws Exception
    {
    ...
    @Test
    public void testAlcoholNonSponsored() throws Exception
    {
